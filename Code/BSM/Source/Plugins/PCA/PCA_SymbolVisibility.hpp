#ifndef __SNL_PCA_SymbolVisibility_hpp__
#define __SNL_PCA_SymbolVisibility_hpp__
...
#    define SNL_PCA_IMPORT  __declspec(dllimport)
#    define SNL_PCA_EXPORT  __declspec(dllexport)
#    define SNL_PCA_DLL_LOCAL
#    define SNL_PCA_DLL_PUBLIC
#else
#    if (defined __GNUC__ && __GNUC__ >= 4)
#        define SNL_PCA_IMPORT      __attribute__ ((visibility("default")))
#        define SNL_PCA_EXPORT      __attribute__ ((visibility("default")))
#        define SNL_PCA_DLL_LOCAL   __attribute__ ((visibility("hidden")))
#        define SNL_PCA_DLL_PUBLIC  __attribute__ ((visibility("default")))
#    else
#        define SNL_PCA_IMPORT
#        define SNL_PCA_EXPORT
#        define SNL_PCA_DLL_LOCAL
#        define SNL_PCA_DLL_PUBLIC
#    endif
#endif

// Build flags for the SNL PCA plugin (if any).
#ifdef SNL_PCA_DLL
#    ifdef SNL_PCA_DLL_EXPORTS
#        define SNL_PCA_API  SNL_PCA_EXPORT
#    else
#        define SNL_PCA_API  SNL_PCA_IMPORT
#    endif
#else
#    define SNL_PCA_API
#endif
