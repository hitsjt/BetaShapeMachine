...
#define VEC_DECLARE_TWOARG_VS(name) \
 template < ::std::size_t D, class T > \
 static inline Vec<D,T> name(const Vec<D,T> &v, const T &a) \
 { \
	using namespace ::std; \
	Vec<D,T> result(VEC_UNINITIALIZED); \
	for (size_t i = 0; i < D; i++) \
...
#define VEC_DECLARE_TWOARG_SV(name) \
 template < ::std::size_t D, class T > \
 static inline Vec<D,T> name(const T &a, const Vec<D,T> &v) \
 { \
	using namespace ::std; \
	Vec<D,T> result(VEC_UNINITIALIZED); \
	for (size_t i = 0; i < D; i++) \
...
#define VEC_DECLARE_THREEARG_VSS(name) \
 template < ::std::size_t D, class T > \
 static inline Vec<D,T> name(const Vec<D,T> &v, const T &a, const T &b) \
 { \
	using namespace ::std; \
	Vec<D,T> result(VEC_UNINITIALIZED); \
	for (size_t i = 0; i < D; i++) \
...
#define VEC_DECLARE_THREEARG_SSV(name) \
 template < ::std::size_t D, class T > \
 static inline Vec<D,T> name(const T &a, const T &b, const Vec<D,T> &v) \
 { \
	using namespace ::std; \
	Vec<D,T> result(VEC_UNINITIALIZED); \
	for (size_t i = 0; i < D; i++) \
